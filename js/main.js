...
//add additional fields
        ...
        $('#addProduct').on('click', function() {
                $('<div class="row"><p class="modelNumField"><label for="modelNumber">Model#</label><br><input type="text" id="modelNumber" name="modelNumber' + i +'" /></p><p class="quantityField"><label for="quantity">Quantity</label><br><input type="number" name="quantity' + i +'" /><br><a href="#" class="remProduct">Remove</a></p></div>').appendTo(scntDiv);
                i++;
                return false;
        });
        ...
        $('#addInstallLoc').on('click', function() {
              ...
              <div class="row"> \
                ...
                <fieldset> \
                  ...
                  <p> \
                    ...
                    <input type="text" name="intstallAddress" hold-off-required=""    /> \
                  </p> \
                  <p> \
                ...
                <div class="row"> \
                  <p> \
                    <label>City</label><br> \
                    <input type="text" name="intstallCity" hold-off-required=""    /> \
                  </p> \
                  <p class="stateSelect"> \
                    <label for="state">State</label><br /> \
                    <select name="intstallState" id="" class="state" hold-off-required="" > \
                  ...
                  <p class="zipField"> \
                    ...
                    <input type="text" maxlength="5" name="Zip Code" data-parsley-type="integer" data-parsley-minlength="5" hold-off-required=""    /> \
                  </p> \
                </div><!-- ./row --> \
                </fieldset> \
                <hr> \
              ...
              <div class="row"> \
                ...
                <a href="#" class="remLocation">Remove</a></p></div>').appendTo(newLocDiv);
                i++;
                return false;
        });
